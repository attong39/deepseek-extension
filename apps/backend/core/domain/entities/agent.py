"""
Agent Entity - Domain-driven design pattern.
...
from app.value_objects.agent.agent_config import AgentConfig
from app.value_objects.agent.agent_lifecycle_status import (
import ValueError
import bool
import cap
import capabilities
...
class Agent(DomainModel):
    ...
    config: AgentConfig = Field(
        default_factory=AgentConfig, description="Cấu hình runtime của agent"
    )
