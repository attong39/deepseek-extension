"""Deprecated Agent WebSocket module.

Kept only to avoid breaking imports. It does not expose a router.
Use `zeta_vn.app.websockets.chat_websocket` or `zeta_vn.app.websockets.training_ws`.
"""
