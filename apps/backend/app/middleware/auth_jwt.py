...
# JWT Configuration - sẽ được load từ config
...
class JWTMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        # Skip authentication cho excluded paths
        ...
        # Set auth info vào request state
    ...
    async def _extract_auth_info(self, request: Request) -> AuthInfo | None:
        ...
        try:
            ...
            # TODO: Check token revocation (Redis blacklist)
...
# TODO: Token revocation/blacklist với Redis
async def revoke_token(token: str) -> None:
    ...
    # await redis.expire("revoked_tokens", JWT_EXPIRY_SECONDS)
